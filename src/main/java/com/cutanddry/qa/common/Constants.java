...
public class Constants {
    ...
    public static String SEC_URL = null;
    public static String WHITELABEL_APP_URL = null;
    public static String LOGIN_AS_APP_URL = null;
    public static String GATE_KEEPER_URL = null;
    ...
    public static String secDomain() {
        if (SEC_URL == null) {
            if (TEST_ENV.equalsIgnoreCase("UAT")){
    ...
    public static String loginAsDomain() {
        if (LOGIN_AS_APP_URL == null) {
            if (TEST_ENV.equalsIgnoreCase("UAT")) {
    ...
    public static String gateKeeperURL() {
        if (GATE_KEEPER_URL == null) {
            if (TEST_ENV.equalsIgnoreCase("UAT")) {
    ...
    public static String whiteLableAppURL() {
        if (WHITELABEL_APP_URL == null) {
            if (TEST_ENV.equalsIgnoreCase("UAT")) {

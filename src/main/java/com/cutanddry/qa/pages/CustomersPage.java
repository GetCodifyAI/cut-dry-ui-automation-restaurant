...
//    String btn_catalogPDPPlusStable = "(//div[translate(normalize-space(text()), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz') = translate('NAME', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')]/following::div//*[name()='svg' and contains(@data-icon, 'plus')])[1]";
    ...
    By btn_cartSummaryExpanded = By.xpath("//div[contains(@class,'_pampsv')]");
    By btn_cartSummaryDropdownArrow = By.xpath("//div[contains(@class,'_pampsv')]//svg[contains(@class,'fa-chevron-up')]");
    String cartSummaryExpandedValue = "//div[contains(text(),'OPTION')]/following-sibling::div";
    String revenueSummaryExpandedValue = "//div[contains(text(),'OPTION')]/following-sibling::div//span[contains(@class,'text-success')]";

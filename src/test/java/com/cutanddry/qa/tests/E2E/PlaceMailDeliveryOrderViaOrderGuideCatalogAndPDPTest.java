...
public class PlaceMailDeliveryOrderViaOrderGuideCatalogAndPDPTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-931")
    public void PlaceMailDeliveryOrderViaOrderGuideCatalogAndPDP() throws InterruptedException {

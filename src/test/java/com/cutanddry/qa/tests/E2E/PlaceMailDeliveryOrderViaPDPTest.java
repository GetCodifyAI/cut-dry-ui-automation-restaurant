...
public class PlaceMailDeliveryOrderViaPDPTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-930")
    public void PlaceMailDeliveryOrderViaPDP() throws InterruptedException {

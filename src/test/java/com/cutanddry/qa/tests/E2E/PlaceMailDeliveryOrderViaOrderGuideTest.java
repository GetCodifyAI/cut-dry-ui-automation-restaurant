...
public class PlaceMailDeliveryOrderViaOrderGuideTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-928")
    public void PlaceMailDeliveryOrderViaOrderGuide() throws InterruptedException {

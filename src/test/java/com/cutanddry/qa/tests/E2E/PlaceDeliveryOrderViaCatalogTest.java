...
public class PlaceDeliveryOrderViaCatalogTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-920")
    public void PlaceDeliveryOrderViaCatalog() throws InterruptedException {

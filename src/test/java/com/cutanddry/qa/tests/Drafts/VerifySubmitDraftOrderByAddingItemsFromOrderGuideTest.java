...
public class VerifySubmitDraftOrderByAddingItemsFromOrderGuideTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-934")
    public void VerifySubmitDraftOrderByAddingItemsFromOrderGuide() throws InterruptedException {

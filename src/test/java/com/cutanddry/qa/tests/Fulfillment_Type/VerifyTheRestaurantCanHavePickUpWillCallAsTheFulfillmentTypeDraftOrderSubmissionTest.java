...
public class VerifyTheRestaurantCanHavePickUpWillCallAsTheFulfillmentTypeDraftOrderSubmissionTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1298")
    public void VerifyTheRestaurantCanHavePickUpWillCallAsTheFulfillmentTypeDraftOrderSubmission() throws InterruptedException {
        ...
        softAssert.assertTrue(Drafts.isLastDraftStatusDisplayed(String.valueOf(totalItemPriceReviewOrder),pickUp),"fulfilment tag should be not displayed as delivery");

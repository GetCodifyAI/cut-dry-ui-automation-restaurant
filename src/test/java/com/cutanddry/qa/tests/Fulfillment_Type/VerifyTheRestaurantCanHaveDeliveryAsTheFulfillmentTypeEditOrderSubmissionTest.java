...
public class VerifyTheRestaurantCanHaveDeliveryAsTheFulfillmentTypeEditOrderSubmissionTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1300")
    public void VerifyTheRestaurantCanHaveDeliveryAsTheFulfillmentTypeEditOrderSubmission() throws InterruptedException {
        ...
        softAssert.assertTrue(Customer.isFulfilmentTypeOrderHistoryDisplayed(orderId,delivery),"The expected fulfillment type is not selected.");

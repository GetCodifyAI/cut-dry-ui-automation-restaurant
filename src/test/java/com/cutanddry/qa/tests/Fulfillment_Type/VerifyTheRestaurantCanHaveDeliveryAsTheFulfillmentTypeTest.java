...
public class VerifyTheRestaurantCanHaveDeliveryAsTheFulfillmentTypeTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1294")
    public void VerifyTheRestaurantCanHaveDeliveryAsTheFulfillmentType() throws InterruptedException {

...
public class VerifyTheRestaurantCanHaveMailDeliveryAsTheFulfillmentTypeTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1296")
    public void VerifyTheRestaurantCanHaveMailDeliveryAsTheFulfillmentType() throws InterruptedException {

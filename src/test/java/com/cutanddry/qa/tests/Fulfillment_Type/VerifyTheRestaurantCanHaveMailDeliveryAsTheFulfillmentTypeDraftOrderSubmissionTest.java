...
public class VerifyTheRestaurantCanHaveMailDeliveryAsTheFulfillmentTypeDraftOrderSubmissionTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1299")
    public void VerifyTheRestaurantCanHaveMailDeliveryAsTheFulfillmentTypeDraftOrderSubmission() throws InterruptedException {
        ...
        softAssert.assertTrue(Drafts.isLastDraftStatusDisplayed(String.valueOf(totalItemPriceReviewOrder),mailDelivery),"fulfilment tag should be not displayed as delivery");

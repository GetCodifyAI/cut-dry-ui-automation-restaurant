...
public class VerifyDoNotSubOptionForCustomerWithBranchCode1246Test extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1200")
    public void VerifyDoNotSubOptionForCustomerWithBranchCode1246() throws InterruptedException {

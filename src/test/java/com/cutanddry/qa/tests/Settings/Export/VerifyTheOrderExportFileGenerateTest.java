...
public class VerifyTheOrderExportFileGenerateTest extends TestBase {
    static User user;
    String type ="Order Export";
    ...
    @Test(groups = "DOT-TC-963")
    public void VerifyTheOrderExportFileGenerate() throws InterruptedException{

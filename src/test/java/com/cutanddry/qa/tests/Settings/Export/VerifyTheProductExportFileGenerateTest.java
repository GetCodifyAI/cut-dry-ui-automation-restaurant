...
public class VerifyTheProductExportFileGenerateTest extends TestBase {
    static User user;
    String type ="Product Export";
    ...
    @Test(groups = "DOT-TC-965")
    public void VerifyTheProductExportFileGenerate() throws InterruptedException{

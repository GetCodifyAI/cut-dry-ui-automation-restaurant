...
public class VerifyPaidInvoiceStatusDropdownTest extends TestBase{
    static User user;
    ...
    @Test(groups = "DOT-TC-565")
    public void VerifyPaidInvoiceStatusDropdown() throws InterruptedException {

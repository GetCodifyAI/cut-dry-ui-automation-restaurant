...
public class VerifyAddPaymentMethodTest extends TestBase {
    ...
    public void VerifyAddPaymentMethodTest()throws InterruptedException {
        ...
        softAssert.assertTrue(Pay.isAddPaymentMethodTextDisplayed(),"miss match  add payment method title");

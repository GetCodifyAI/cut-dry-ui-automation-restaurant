...
public class VerifyTheAutoApplyCreditMemosOnOPPortalWhenFeatureDisabledTest extends TestBase {
    static User user;
    ...
    public void VerifyTheAutoApplyCreditMemosOnOPPortalWhenFeatureDisabled() throws InterruptedException {

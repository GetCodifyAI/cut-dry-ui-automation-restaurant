...
public class VerifyThatTheNewArrivalsSectionIsAvailableInCatalogOGEditFlowTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1483")
    public void VerifyThatTheNewArrivalsSectionIsAvailableInCatalogOGEditFlow() throws InterruptedException {

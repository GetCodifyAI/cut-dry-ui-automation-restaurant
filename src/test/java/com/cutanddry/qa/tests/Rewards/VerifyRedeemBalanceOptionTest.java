...
public class VerifyRedeemBalanceOptionTest extends TestBase{
    static User user;
    ...
    @Test(groups = "DOT-TC-590")
    public void VerifyRedeemBalanceOptionTest()throws InterruptedException {

...
public class VerifyThatTheOrderUponRecreatingWithInactiveItemsTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-2539")
    public void VerifyThatTheOrderUponRecreatingWithInactiveItems() throws InterruptedException {

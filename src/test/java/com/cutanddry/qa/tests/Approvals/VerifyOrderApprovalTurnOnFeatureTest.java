...
public class VerifyOrderApprovalTurnOnFeatureTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-205")
    public void verifyOrderApprovalTurnOnFeatureTest()throws InterruptedException {

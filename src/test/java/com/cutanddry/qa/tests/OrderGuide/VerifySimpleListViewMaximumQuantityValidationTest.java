...
public class VerifySimpleListViewMaximumQuantityValidationTest extends TestBase {
    static User user;
    static String validQuantity = "1999";
    ...
    public void VerifySimpleListViewMaximumQuantityValidation() throws InterruptedException {
        ...
        Customer.enterQuantitySimpleListViewByIndex(1, validQuantity);
        Customer.tabAwayFromQuantityField();
        softAssert.assertFalse(Customer.isMaxQuantityErrorModalDisplayed(), "Error modal should not display for valid quantity 1999");
        String qty1 = Customer.getQuantitySimpleListViewByIndex(1);
        softAssert.assertEquals(qty1, validQuantity, "Valid quantity 1999 should be accepted");
        ...
        softAssert.assertEquals(qty2AfterError, "0", "Quantity field should be cleared to 0 after error");

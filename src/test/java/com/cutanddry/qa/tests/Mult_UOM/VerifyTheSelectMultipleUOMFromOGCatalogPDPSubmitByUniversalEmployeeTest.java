...
public class VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByUniversalEmployeeTest extends TestBase {
    static User user;
    String searchItemName2 = "Organic Bananas - 2 LB";
    String searchItemCode = "01409";
    String searchItemCode2 = "00529";
    String OperatorName = "274855811";
    ...
    @Test(groups = "DOT-TC-1016")
    public void VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByUniversalEmployee() throws InterruptedException {

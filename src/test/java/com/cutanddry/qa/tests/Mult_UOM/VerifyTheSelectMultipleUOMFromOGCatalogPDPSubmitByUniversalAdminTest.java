...
public class VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByUniversalAdminTest extends TestBase {
    static User user;
    ...
    public void VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByUniversalAdmin() throws InterruptedException {

...
public class VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByWhiteLabelBookkeeperTest extends TestBase {
    static User user;
    String searchItemName2 = "Carrot - Baby Peeled - 1 LB";
    String searchItemCode2 = "01409";
    String searchItemCode = "00529";
    String OperatorName = "Ayendra IFC WL";
    ...
    @Test(groups = "DOT-TC-1019")
    public void VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByWhiteLabelBookkeeper() throws InterruptedException {

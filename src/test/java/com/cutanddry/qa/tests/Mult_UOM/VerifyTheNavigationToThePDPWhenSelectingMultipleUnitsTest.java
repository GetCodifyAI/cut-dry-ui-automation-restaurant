...
public class VerifyTheNavigationToThePDPWhenSelectingMultipleUnitsTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-803")
    public void VerifyTheNavigationToThePDPWhenSelectingMultipleUnits() throws InterruptedException {

...
public class VerifySelectMultipleUOMItemFromOGCatalogAndPDPByUniversalAdminTest extends TestBase {
    static User user;
    String searchItemName = "Organic Bananas - 2 LB";
    String searchItemCde = "00529";
    String searchItemCode = "98342";
    ...
    @Test(groups = "DOT-TC-1013")
    public void VerifySelectMultipleUOMItemFromOGCatalogAndPDPByUniversalAdmin() throws InterruptedException {

...
public class VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByUniversalManagerTest extends TestBase {
    static User user;
    String searchItemName2 = "Organic Bananas - 2 LB";
    String searchItemCode = "01409";
    String searchItemCode2 = "00529";
    String OperatorName = "Aselabookkeeper4";
    ...
    @Test(groups = "DOT-TC-1014")
    public void VerifyTheSelectMultipleUOMFromOGCatalogPDPSubmitByUniversalManager() throws InterruptedException {

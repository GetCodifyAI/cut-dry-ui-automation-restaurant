...
public class VerifyPurchaseHistoryDisplayInOrderGuideAndPDPWhenDisplayPurchaseHistoryToggleEnableTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1430")
    public void VerifyPurchaseHistoryDisplayInOrderGuideAndPDPWhenDisplayPurchaseHistoryToggleEnable() throws InterruptedException {

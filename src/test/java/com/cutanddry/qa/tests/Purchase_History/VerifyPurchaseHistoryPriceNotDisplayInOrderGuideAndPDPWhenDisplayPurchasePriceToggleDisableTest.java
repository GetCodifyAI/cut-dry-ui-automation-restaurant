...
public class VerifyPurchaseHistoryPriceNotDisplayInOrderGuideAndPDPWhenDisplayPurchasePriceToggleDisableTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1433")
    public void VerifyPurchaseHistoryPriceNotDisplayInOrderGuideAndPDPWhenDisplayPurchasePriceToggleDisable() throws InterruptedException {
        ...
        InternalTools.displayPurchasePriceOnOperatorToggle(false);

...
public class VerifyReportIssueButtonIsDisabledTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-489")
    public void VerifyReportIssueButtonIsDisabled() throws InterruptedException{
        ...
        softAssert.assertFalse(CreditRequests.isReportIssueButtonDisplayed(),"Credit report issue button not display");

...
public class VerifyNavigatingToOrderGuideTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-125")
    public void VerifyNavigatingToOrderGuide() throws InterruptedException {

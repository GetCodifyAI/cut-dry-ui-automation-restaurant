...
public class ValidateSupplierSelectionModalAfterLogIinAndSessionTest extends TestBase {
    static User user;
    ...
    static String profileName = "Faizul+West";
    ...
    @Test(groups = "DOT-TC-390")
    public void ValidateSupplierSelectionModalAfterLogIinAndSession() throws InterruptedException {
        ...
        Dashboard.clickOnProfile(profileName);

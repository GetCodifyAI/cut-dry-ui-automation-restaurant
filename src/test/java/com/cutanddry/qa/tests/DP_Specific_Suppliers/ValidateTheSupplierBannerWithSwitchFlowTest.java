...
public class ValidateTheSupplierBannerWithSwitchFlowTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-121")
    public void ValidateTheSupplierBannerWithSwitchFlow() throws InterruptedException {
        ...
        softAssert.assertTrue(Dashboard.isSavalFoodServiceBannerDisplayed(),"1932 by saval banner not displayed");

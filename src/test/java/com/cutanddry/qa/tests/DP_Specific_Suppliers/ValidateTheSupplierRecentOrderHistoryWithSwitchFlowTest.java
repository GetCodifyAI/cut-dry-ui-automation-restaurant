...
public class ValidateTheSupplierRecentOrderHistoryWithSwitchFlowTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-120")
    public void ValidateTheSupplierRecentOrderHistoryWithSwitchFlow() throws InterruptedException {
